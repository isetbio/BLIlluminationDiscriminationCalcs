...
%
% This script can take up to several hours going through the calculations.
% Therefore, there is the option to load previously calculated data for
% expedited plotting.
%
% 12/6/16  xd  wrote it
% 6/1/17   xd  moved into script directory, renamed, refactored
...
% Plot each subject as a individual plot
individualPlots = false;

% Save fitted model data
saveData = false;
...
for subjectNumber = 1:length(orderOfSubjects)
    ...
    [perSubjectFittedThresholds{subjectNumber},fittedNoiseLevel(subjectNumber)]...
        ...
        [b y g r],'NoiseVector',calcParams.noiseLevels,'NewFigure',individualPlots);
