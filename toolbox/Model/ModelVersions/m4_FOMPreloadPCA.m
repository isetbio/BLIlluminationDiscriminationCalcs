function results = m4_FOMPreloadPCA(calcParams,mosaic,color)
...
% Load the pca and m and s
pathToNeutral = fullfile(databaseDir,'NeutralPCAData');
load(fullfile(pathToNeutral,'MeanAndStdForNeutral.mat'));
load(fullfile(pathToNeutral,'ColorPCACoeffNeutral.mat'));
