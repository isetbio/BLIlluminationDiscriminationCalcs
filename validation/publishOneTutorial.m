function publishOneTutorial
    ...
    p = struct(...
        ...
        'ghPagesCloneDir',          getpref('BLIllumCalcs', 'clonedGhPagesLocation'), ... % local directory where the project's gh-pages branch is cloned
        'wikiCloneDir',             getpref('BLIllumCalcs', 'clonedWikiLocation'), ...    % local directory where the project's wiki is cloned
