function vScriptsList = illcalcsListAllValidationDirs
%
...
vScriptsList = {...
        {fullfile(rootDir, 'scripts', 'EyeMovements')} ...
        {fullfile(rootDir, 'scripts', 'FirstOrderModel')} ...
        {fullfile(rootDir, 'scripts', 'SPDSubsampling')} ...
        {fullfile(rootDir, 'scripts', 'NoiseFunctions')} ...
    };
