...
% 3/12/2015   xd  wrote it
    ...
    %
    % NEED TO CONSOLIDATE THIS LIST, WHICH APPEARS IN MORE THAN ONE
    % FUNCTION, IN ONE PLACE.  COULD PASS AS INPUT TO THIS ROUTINE FROM A
    % MASTER CALLING ROUTINE.
    ...
    % 
    % SHOULD DEFINE AN OUTPUT DATA FILE WHERE DATA GENERATED BY THIS
    % PROJECT GET WRITTEN. POSSIBLE WE DON'T WANT TO WRITE OUT THIS
    % DISPLAY OBJECT, POSSILE WE DO.  BUT IT SHOULDN'T END UP IN "Code"
